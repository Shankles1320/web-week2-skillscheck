...
var groceries = ['banana', 'apple', 'berries']
...
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one paramter called item. Add the item param to the end of the groceries array created above. Inside of addItem, invoke displayData() 
//which is a function we created that takes care of some of the leg work unrelated to this module.
...
//////////////////STEP 6////////////////////
//Create a function called 'checkGroceryCount'. Inside of the function check the total number of groceries you need to get using .length. Using an else/if statement, check if the number is 
//greater than or equal to 5, return the string 'That looks like a big trip' from the function. If the number of groceries is equal to one, return the string '1 item'. For numbers between 1 and 5, 
