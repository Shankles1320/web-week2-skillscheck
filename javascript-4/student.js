...
var faveColors = ['red', 'purple', 'green'];
...
var me = {
    firstName: 'Trey',
    superHeroName: 'Tubular Trey',
    homeTown: 'Tempe',
    superPowers: ['rock-climbing', 'xray-vision', 'flying'],
...
// Next, create a for loop to loop over the array. If any of the colors you chose is 'blue', change it's value to '#4D4DFF' which is just a more appealing color of blue. Outside of the for 
//loop but still inside of setColor, invoke the function called background which will take in three arguments. These arguments should be each item of your array. 
...
//That is what this function will do. Loop over the object and change each keys value to 'redacted'. Outside of the loop but still in the redactInfo function, run the function redacted() 
