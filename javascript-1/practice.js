...
// Create a function called 'bigOrSmall' that takes in one parameter, arr. Create a new array inside of bigOrSmall called 'answers'. Loop over the passed in arr param. If the number is GREATER than 100, 
//push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the answers array. Return the answers array inside of the function
...
// Create a function called 'arrayReverser' that takes in one parameter, arr. Inside of arrayReverser, create an empty array called 'reversed'. Using a for loop, loop over the passed in array in reverse 
...
// Last, lets use .forEach to find the index of each item in the array. First, create an empty array called myNumbersIndex. Next, using forEach, push each items index from the myNumbers array to the 
//myNumbersIndex array

myNumbersIndex = []
myNumbers.forEach(function(currentValue, index){
...
var forTheLoveOfGeorge = notGeorge.map(function(element, index, array){
	if (element !== 'George'){
		return 'George'
	}
})
...
var enemies = people.filter(function(element, index, array){
...
var totallyAwesome = people.reduce(function(total, element, index, array){
